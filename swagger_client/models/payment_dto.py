...
class PaymentDto(object):
    ...
    @property
    def name(self):
        """Gets the name of this PaymentDto.  # noqa: E501


        :return: The name of this PaymentDto.  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PaymentDto.


        :param name: The name of this PaymentDto.  # noqa: E501
